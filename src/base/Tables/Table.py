...
class Table(Utilities):
    ...
    def __getitem__(self, slices):
        ...
        try:
            ...
            self.fatalErrorIn(self.__getitem__, "Slicing error", err)
        ...
        return Table(data, ranges, order).setOpts(self.opts)
    ...
    def mergeTable(self, fieldName, secondTable):
        ...
        secondTable: table
            Table containing the data to introduce
    ...
    def plot(self, xVar, yVar, isoSurf=None, **argv):
        ...
        try:
            ...
            self.fatalErrorIn(self.plot, "Failed plotting tabulation", err)
