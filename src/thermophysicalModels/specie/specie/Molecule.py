...
class Molecule(Utilities):
    ...
    def __init__(self, specieName, atomicSpecie, numberOfAtoms):
        ...
        #Check arguments:
        try:
            Utilities.checkType(specieName, str, entryName="specieName")
            Utilities.checkInstanceTemplate(atomicSpecie, [Atom.empty()], entryName="atomicSpecie")
            Utilities.checkInstanceTemplate(numberOfAtoms, [1.], entryName="numberOfAtoms")
    ...
    def __contains__(self, entry):
        ...
        #Argument checking:
        try:
            self.__class__.checkTypes(entry, [str, Atom], "entry")
        except BaseException as err:
    ...
    def __index__(self, entry):
        ...
        #Argument checking:
        try:
            self.__class__.checkType(entry, Atom, "entry")
    ...
    def __getitem__(self, atom):
        ...
        #Argument checking:
        try:
            self.__class__.checkTypes(atom, [str, Atom, int], entryName="atom")
        except BaseException as err:
        ...
        try:
            ...
            self.fatalErrorIn(self.__getitem__, "failure retrieving atom in molecule", err)
